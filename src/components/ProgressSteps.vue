...
<template>
  <div class="progress-container">
    ...
    <div class="controls">
      <button @click="prevStep" type="button" :disabled="currentStep === 0" class="btn">Previous</button>
      <button @click="nextStep" type="button" :disabled="currentStep === steps.length - 1" class="btn">Next</button>
    </div>
  </div>
</template>
